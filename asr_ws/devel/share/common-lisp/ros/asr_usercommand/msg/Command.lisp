...
(cl:in-package asr_usercommand-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asr_usercommand-msg:<Command> is deprecated: use asr_usercommand-msg:Command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asr_usercommand-msg:command-val is deprecated.  Use asr_usercommand-msg:command instead.")
  (command m))
